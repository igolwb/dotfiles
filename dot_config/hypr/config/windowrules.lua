...
hl.window_rule({ match = { class = "^(vesktop|discord)$" }, opacity = "0.9 override" })
hl.window_rule({ match = { class = "^(Spotify)$" }, opacity = "0.9 override" })
...
hl.window_rule({ match = { class = "^(org.kde.ark)$" }, size = "(monitor_w*0.30) (monitor_h*0.30)" })
