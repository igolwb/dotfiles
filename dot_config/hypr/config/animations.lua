...
hl.curve("standardDecel", { type = "bezier",   points = { { 0.3  , 0    }, { 0, 1      } } })
...
hl.curve("spring_windowOpen", { type = "spring", mass = 1.0, stiffness = 300, dampening = 35 })
hl.curve("spring_windowOut", { type = "spring", mass = 1.0, stiffness = 150, dampening = 20 })
hl.curve("spring_workspace", { type = "spring", mass = 1.0, stiffness = 400, dampening = 50 })

-- Configs:
-- windows
hl.animation({ leaf = "windowsIn", enabled = true, speed = 5, bezier = "standardDecel", style = "slide" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 5, bezier = "standardDecel", style = "slide" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 5, bezier = "standardDecel", style = "slide" })


-- layers
hl.animation({ leaf = "layersIn", enabled = true, speed = 5, bezier = "standardDecel", style = "popin 93%" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 20, bezier = "standardDecel", style = "popin 94%" })

-- fade
hl.animation({ leaf = "fadeIn", enabled = true, speed = 10, bezier = "emphasizedDecel" })
