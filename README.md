...
```bash
sudo pacman -S yay chezmoi zed zen-browser foot spotify-launcher yazi lazygit lazydocker ddcutil nvim httpie tmux vesktop prismlauncher lact protonup-qt rocm-smi-lib
```
